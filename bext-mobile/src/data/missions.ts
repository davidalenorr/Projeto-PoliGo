...
export const missions: Mission[] = [
  // Fase 1: Detetive das Formas
  {
    id: 'fase1_m1',
    phaseId: 'fase1',
    title: 'O Cacador de Triangulos',
    description: 'Capture 5 triangulos escondidos em estruturas urbanas de Belo Jardim',
    difficulty: 'fácil',
    points: 20,
    objective:
      'Observe cenas da Igreja Matriz e da antiga Estacao Ferroviaria de Belo Jardim e toque para capturar 5 triangulos ocultos.',
    tips: [
      'Telhados, vigas e encontros de linhas costumam formar triangulos',
      'Compare inclinacoes de linhas para encontrar vertices',
      'Foque em detalhes arquitetonicos repetidos',
    ],
  },
  {
    id: 'fase1_m2',
    phaseId: 'fase1',
    title: 'A Armadilha da Convexidade',
    description: 'Arraste formas para classificar convexos e nao-convexos',
    difficulty: 'médio',
    points: 25,
    objective:
      'Arraste placas e decoracoes em forma de estrela e seta para a caixa verde (convexo) ou vermelha (concavo).',
    tips: [
      'Convexo: todos os vertices apontam para fora',
      'Concavo: pelo menos um recorte para dentro',
      'A tecnica da banda elastica continua valendo',
    ],
  },
  {
    id: 'fase1_m3',
    ...
    description: 'Conte os lados e escolha o nome correto do poligono',
    difficulty: 'fácil',
    points: 20,
    objective:
      'Toque nos lados de contornos inspirados em pracas e predios e selecione o nome correto (Heptagono, Eneagono e outros).',
    tips: [
      'Conte os lados em sequencia para evitar repeticao',
      'Lados e vertices sempre possuem a mesma quantidade',
      'Associe numero de lados ao nome do poligono',
    ],
  },
